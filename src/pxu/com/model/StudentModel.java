...
public class StudentModel {
    ...
    public String toString() {
        return "StudentModel{" + "student_id=" + student_id + ", student_name=" + student_name + ", faculty=" + faculty + ", major=" + major + ", gamil=" + gmail + ", phone_number=" + phone_number + ", room_id=" + room_id + ", gender=" + gender + ", hometown=" + hometown + ", status=" + status + ", violation_count=" + violation_count + ", check_in_date=" + check_in_date + ", birth_date=" + birth_date + ", student_image=" + student_image + '}';
    }
}
